...
export default function DeployView() {
  ...
  const getActiveCode = () => {
    switch (activeTab) {
      case 'dockerfile':
        return productionDockerfile;
      case 'compose':
        return productionDockerCompose;
      default:
        return productionEnvExample;
    }
  };
      ...
      <div className="bg-[#0f172a] border-b border-[#1e293b] px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">
            Configure environment settings and deploy Docker clusters behind private VPC subnets.
          </p>
        </div>
      ...
      {activeTab === 'vpc' ? (
          ...
          <div className="bg-[#0f172a] rounded-xl border border-[#1e293b] p-6 shadow-2xl max-w-4xl space-y-5">
            <div className="flex items-center space-x-2 text-emerald-400 border-b border-[#1e293b] pb-3">
              ...
              <h3 className="font-bold text-white text-[11px] uppercase tracking-wider font-mono">
                Secure Production VPC Topology Schema
              </h3>
            </div>
            ...
            <div className="space-y-4 font-sans">
              ...
              <div className="p-4 bg-slate-950 border border-[#1e293b] rounded-xl relative">
                <span className="absolute top-2.5 right-3 text-[9px] font-mono font-bold text-slate-500">
                  TIER-1 (PUBLIC)
                </span>
                <h4 className="font-bold text-white text-xs">Public Boundary / DNS / Gateways</h4>
                <p className="text-[11px] text-slate-400 mt-1">
                  Cloudflare WAF DNS queries translate HTTPS on Port 443 ↴
                </p>
              ...
              <div className="flex justify-center">
                <div className="h-6 w-0.5 border-l border-dashed border-[#1e293b]"></div>
              </div>

              {/* Box 2: Private Network Services Tier */}
              <div className="p-4 bg-slate-950 border border-[#1e293b] rounded-xl relative">
                <span className="absolute top-2.5 right-3 text-[9px] font-mono font-bold text-emerald-400">
                  TIER-2 (PRIVATE ACCESS ONLY)
                </span>
                <h4 className="font-bold text-white text-xs">
                  Application Subnets (Multi-AZ Clusters)
                </h4>
                <p className="text-[11px] text-slate-400 mt-1">
                  Containers scaled horizontally inside private isolation zones. Internal load
                  distributing handles load ↴
                </p>
              ...
              <div className="p-4 bg-slate-950 border border-[#1e293b] rounded-xl relative">
                <span className="absolute top-2.5 right-3 text-[9px] font-mono font-bold text-rose-400">
                  TIER-3 (STRICT ISOLATION)
                </span>
                <h4 className="font-bold text-white text-xs">Locked Database Subnets</h4>
                <p className="text-[11px] text-slate-400 mt-1">
                  Strictly isolated, rejecting direct ingress except through Node-Service AZ private
                  IPs.
                </p>
                <div className="mt-3 flex flex-wrap gap-2">
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 text-slate-300">
                <li className="space-y-1">
                  ...
                  <p className="text-[11px] text-slate-450 leading-normal font-sans">
                    Database and Redis instances have no public IPv4 addresses, nullifying active
                    external network attack surfaces.
                  </p>
                </li>
                <li className="space-y-1">
                  <span className="font-bold text-[#10b981]">2. SSL/TLS Termination</span>
                  <p className="text-[11px] text-slate-450 leading-normal font-sans text-slate-400">
                    ALBs terminate SSL configurations at Tier-1 boundary, proxying plain, fast HTTP
                    internally to Docker clusters over private networks.
                  </p>
                </li>
                <li className="space-y-1">
                  <span className="font-bold text-[#10b981]">3. Multi-AZ Failovers</span>
                  <p className="text-[11px] text-slate-450 leading-normal font-sans text-slate-300">
                    Horizontally repeating nodes across Multi Availability-Zones shields against
                    regional physical outages gracefully.
                  </p>
                </li>
                <li className="space-y-1">
                  <span className="font-bold text-[#10b981]">4. WAF Filtering Rules</span>
                  <p className="text-[11px] text-slate-450 leading-normal font-sans">
                    Cloudflare processes connections first, filtering injection patterns, standard
                    XSS, and volumetric attacks before reaching internal proxy servers.
                  </p>
                </li>
              </ul>
            </div>
        ...
        <div className="flex-grow flex flex-col lg:flex-row overflow-hidden bg-[#020617]">
          ...
          <div className="w-full lg:w-96 border-b lg:border-b-0 lg:border-r border-[#1e293b] overflow-y-auto p-4 space-y-3 shrink-0 bg-[#0f172a]/30">
            <h4 className="text-[10px] font-bold text-[#64748b] uppercase tracking-widest font-mono px-2">
              Secure Parameters List
            </h4>
            <div className="space-y-1">
              {[
                ...
                return (
                  ...
                  >
                    <Server
                      className={`h-4.5 w-4.5 mt-0.5 shrink-0 ${isSelected ? 'text-[#10b981]' : 'text-slate-500'}`}
                    />
                    <div className="min-w-0">
                      <div className="font-bold text-white truncate">{key}</div>
                      <p className="text-[10px] text-slate-450 font-sans mt-1 line-clamp-1 leading-normal">
                        {getEnvExplToKey(key)}
                      </p>
                    </div>
                  </button>
          ...
          <div className="flex-grow flex flex-col justify-between p-6">
            <div className="space-y-6">
              <div className="flex items-center space-x-2.5 border-b border-[#1e293b]/60 pb-3">
                ...
                <h3 className="font-extrabold text-white text-[10px] font-mono uppercase tracking-widest">
                  Variable Context Inspector
                </h3>
              </div>
              ...
              <div>
                ...
                <h4 className="text-sm font-extrabold text-white mt-4 font-sans uppercase tracking-wide">
                  Security configurations explanation
                </h4>
              ...
              <div className="bg-amber-950/10 rounded-xl border border-amber-900/40 p-4 space-y-1.5 font-sans">
                <div className="text-amber-500 font-bold text-xs uppercase font-mono tracking-wider">
                  Production Compliance Guideline:
                </div>
                <p className="text-[11px] text-slate-400 leading-relaxed font-sans">
                  Never commit raw secrets, custom salts, or production certificates directly into
                  Git repository structures. Use Vault configs, AWS Secrets manager or container
                  cloud environments directly, parsing parameters at runtime execution.
                </p>
              </div>
            </div>
