    ...
    <div className="p-6 bg-[#020617] h-full overflow-y-auto space-y-6">
      <div>
        ...
        <p className="text-xs text-slate-400 mt-1 leading-relaxed">
          A production-ready SaaS authentication service cannot be completed overnight. Follow this
            ...
            >
              ...
              >
                <div className="flex items-start space-x-4 min-w-0">
                  <div
                    className={`h-10 w-10 rounded-xl flex items-center justify-center font-bold text-xs shrink-0 shadow-sm ${
                      isFinished
                  ...
                  <div className="min-w-0">
                    <div className="flex items-center space-x-2.5">
                      <h3 className="font-bold text-white text-sm font-sans leading-tight truncate">
                        {phase.title}
                      </h3>
                    ...
                    <p className="text-xs text-slate-400 mt-1 line-clamp-1 leading-normal font-sans">
                      {phase.description}
                    </p>
                  </div>
                </div>
              ...
              {isExpanded && (
                <div className="px-5 pb-6 border-t border-[#1e293b]/60 pt-5 space-y-5 animate-fadeIn">
                  ...
                  <div className="space-y-2.5">
                    <h4 className="text-[10px] text-[#64748b] font-bold uppercase tracking-widest font-mono">
                      Milestone Checklist
                    </h4>
                  ...
                  <div className="bg-slate-950 rounded-xl p-4 border border-[#1e293b] space-y-2.5">
                    <h4 className="text-[10px] text-[#64748b] font-bold uppercase tracking-widest font-mono">
                      Tangible Deliverables / Audit outputs
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {phase.deliverables.map((del, i) => (
                        <span
                          key={i}
                          className="px-2.5 py-1 bg-[#0f172a] border border-[#1e293b] text-[9px] text-slate-300 font-mono rounded-lg"
                        >
                          📦 {del}
                        </span>
                      ))}
